namespace Microsoft.StyleCop.CSharp
{
    ...
    public sealed class ElseStatement : Statement
    {
        ...
        internal ElseStatement(CsTokenList tokens, Expression conditionExpression) : base(StatementType.Else, tokens)
        {
        ...
        private sealed class _get_AttachedStatements_d__0 : IEnumerable<Statement>, IEnumerable, IEnumerator<Statement>, IEnumerator, IDisposable
        {
            ...
            public ElseStatement __4__this;
            ...
            public bool MoveNext()
            {
                ...
                {
                    this.__2__current = this.__4__this.elseStatement;
                    this.__1__state = 1;
                    return true;
                }
            Label_006B:
            ...
            public IEnumerator<Statement> GetEnumerator()
            {
                ...
                ElseStatement._get_AttachedStatements_d__0 d__ = new ElseStatement._get_AttachedStatements_d__0(0);
