namespace Microsoft.StyleCop.CSharp
{
    ...
    public sealed class ConditionalLogicalExpression : Expression
    {
        ...
        internal ConditionalLogicalExpression(CsTokenList tokens, Operator operatorType, Expression leftHandSide, Expression rightHandSide) : base(ExpressionType.ConditionalLogical, tokens)
        {
